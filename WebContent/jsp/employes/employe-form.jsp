...
<head>
    ...
    <title>Formulaire Employe - OneOfOne</title>
    <link rel="stylesheet" href="../../css/employes/employe-form.css">
</head>
<body>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (!hasError) {
            ...
            if (success) {
                String message = id > 0 ? "Employe modifie avec succes !" : "Employe ajoute avec succes !";
    ...
    <div class="form-panel">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nom" required placeholder="Ex : Jean Rakoto" value="<%= employe != null ? employe.getNom() : "" %>">
            </div>
            
            <div class="form-group">
                <label>Email *</label>
                <input type="email" name="email" required placeholder="Ex : jean@email.com" value="<%= employe != null ? employe.getEmail() : "" %>">
            </div>
