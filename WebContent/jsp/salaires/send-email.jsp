...
try {
    ...
    if (employe == null || employe.getEmail() == null || employe.getEmail().isEmpty()) {
        out.print("{\"success\":false,\"message\":\"Employe ou email introuvable\"}");
        return;
    }
    ...
    String html = "<html><body style='font-family:Arial,sans-serif;line-height:1.6;'>"
            ...
            + "<tr><th style='border:1px solid #ddd;padding:8px;text-align:left;background:#f5f5f5;'>Detail</th><th style='border:1px solid #ddd;padding:8px;text-align:left;background:#f5f5f5;'>Valeur</th></tr>"
            ...
            + "</table>"
            + "<p>Merci,<br/>L'equipe One of One</p>"
            + "</body></html>";
    message.setContent(html, "text/html; charset=utf-8");

    Transport.send(message);
    out.print("{\"success\":true,\"message\":\"Email envoye\"}");
} catch (Exception ex) {
