...
<script>
    // Appliquer l'etat de la sidebar IMMeDIATEMENT avant le rendu
...
<div class="brand" id="toggleSidebar">
    <img src="${pageContext.request.contextPath}/svg/logo2.svg" class="brand-logo" style="color: #fff;" alt="Logo">
    ...
    <div class="brand-text">
        ...
        <nav>
            <a href="${pageContext.request.contextPath}/jsp/dashboard/dashboard.jsp" >
            ...
            <a href="${pageContext.request.contextPath}/jsp/stock/stock-list.jsp">
            ...
            <a href="${pageContext.request.contextPath}/jsp/produits/produits.jsp">
            ...
            <a href="${pageContext.request.contextPath}/jsp/commandes/commandes.jsp">
            ...
            <a href="${pageContext.request.contextPath}/jsp/livraisons/livraison-list.jsp">
            ...
            <a href="${pageContext.request.contextPath}/jsp/clients/client-list.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg> <span>Clients</span>
            </a>
            <a href="${pageContext.request.contextPath}/jsp/employes/employe-list.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg> <span>Employes</span>
            </a>
            <a href="${pageContext.request.contextPath}/jsp/salaires/salaire-list.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg> <span>Salaires</span>
            </a>

            <a href="${pageContext.request.contextPath}/jsp/corbeille/corbeille.jsp">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M1 7h22M8 7V4a1 1 0 011-1h6a1 1 0 011 1v3"/></svg> <span>Corbeille</span>
            </a>

            <a href="${pageContext.request.contextPath}/jsp/finances/finance-list.jsp">
            ...
            <a href="${pageContext.request.contextPath}/jsp/auth/login.jsp?logout=true" style="margin-top:auto;color:#f5c0c0;">
...
// Appliquer l'etat initial au DOM
