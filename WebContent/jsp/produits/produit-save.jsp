...
<%
    ...
    // conserver l'ancienne image par defaut
    ...
    if (filePart != null && filePart.getSize() > 0) {
        // Recuperer le nom du fichier original
        ...
        // Seul le nom du fichier est stocke en base
    ...
    // ── Traitement des matieres premieres (si creation) ──
        ...
        if (matiereIdsParam != null && quantitesParam != null) {
            for (int i = 0; i < matiereIdsParam.length; i++) {
                ...
                try {
                    ...
                    request.setAttribute("erreur", "Matiere invalide.");
    ...
    try {
        if (isEdit) {
            ...
            dao.modifier(p);
            session.setAttribute("flash", "Produit modifie avec succes.");
        } else {
            dao.ajouter(p, matiereIds, quantites);
            session.setAttribute("flash", "Produit ajoute avec succes.");
        }
