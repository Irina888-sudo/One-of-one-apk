...
('Pierre Roche',          'proche@outlook.com',       '06 45 12 98 67', '8 Bis Quai des Orfevres, 33000 Bordeaux',  'ACTIF'),
...
('Emma Bernard',          'emma.b@gmail.com',         '06 55 44 33 22', '7 Allee des Roses, 31000 Toulouse',         'ACTIF'),
('Lucas Martin',          'lucas.m@studio.com',       '06 99 88 77 66', '22 Rue des Arts, 44000 Nantes',             'ACTIF'),
('Chloe Girard',          'chloe.g@mail.fr',          '07 33 44 55 66', '9 Boulevard Haussmann, 75009 Paris',        'BLOQUE'),
('Thomas Petit',          'thomas.p@email.com',       '06 22 11 00 99', '4 Rue Victor Hugo, 13001 Marseille',        'ACTIF'),
('Ines Morel',            'ines.m@domain.fr',         '07 66 55 44 33', '18 Avenue de la Gare, 67000 Strasbourg',   'ACTIF'),
('Antoine Leroy',         'antoine.l@outlook.com',    '06 44 55 66 77', '30 Rue du Commerce, 75015 Paris',           'ACTIF');


SELECT 'Clients inseres :' AS info, COUNT(*) AS nb FROM client;
